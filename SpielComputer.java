...
public class SpielComputer extends Spiel2 {
	...
	/**
	 * Finds the best option to choose a color, finds which move can get most of the boxes
	 * @param c
	 */
	...
	/**
	 * Calculates all the moves beforehand.
	 * Finds the best moves based on the depth of the engine
	 * @param b
	 * @return
	 */
	public char findMost(boolean b ){
		...
		if( steps == 0){		
			...
			for(String mov:moves){
				...
				rankedMoves.add(new AbstractMap.SimpleEntry<Integer, String>(size, mov));
